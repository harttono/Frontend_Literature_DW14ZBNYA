...
function AddCategory(props){
    ...
    const {isLoading,error,category,newLiterature} = state;
        ...
        <div className="message_box">
            <Modal.Body>
                <div className="input-group">
                    ...
                    <input type="text" className="form-control" autoComplete="off" onChange={ (e) => setName(e.target.value)}  aria-label="name" aria-describedby="basic-addon1"/>
                </div>
            </Modal.Body>   
            <Modal.Footer>
